...
class ApiResponseSubscriber implements EventSubscriberInterface
{
    ...
    const DEFAULT_ACCESS_CONTROL_EXPOSE_HEADERS = 'Accept,Authorization,X-Requested-With,If-Modified-Since,Content-Type,Cache-Control,Range';
    const DEFAULT_ACCESS_CONTROL_EXPOSE_METHODS = 'Access-Control-Allow-Methods';
    const ACCESS_CONTROL_EXPOSE_CREDENTIALS = 'Access-Control-Allow-Credentials';
...
//        $response->headers->set(self::ACCESS_CONTROL_EXPOSE_CREDENTIALS,true);
