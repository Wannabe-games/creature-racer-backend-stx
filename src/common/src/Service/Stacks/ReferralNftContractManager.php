...
class ReferralNftContractManager
{
    ...
    {
        return CommandService::exec('stx-referral-nft-mint', [$refCode, $uri], $verbose);
    }
    ...
    {
        return CommandService::exec('stx-referral-nft-sign-mint', $params, $verbose);
    }

    public function specialMint(string $refCode, string $uri = '', bool $verbose = false): ?string
    {
        return CommandService::exec('stx-referral-nft-special-mint', [$refCode, $uri], $verbose);
    }
