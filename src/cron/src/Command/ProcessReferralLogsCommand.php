...
class ProcessReferralLogsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->getApplication()->find('app:payment-contract:event:payment')->run(new ArrayInput([
        ...
        $this->getApplication()->find('app:user-referral-pool:get-settlement')->run(new ArrayInput([
