...
final class UserReferralPoolWithdrawDecorator implements OpenApiFactoryInterface
{
    ...
    public function __invoke(array $context = []): OpenApi
    {
        ...
        $pathItem = new Model\PathItem(
            ref: 'Withdraw referral pool',
            get: new Model\Operation(
                operationId: 'withdrawRewardPool',
                tags: ['ReferralPool'],
                responses: [
                    '200' => [
                        'description' => 'Withdraw referral pool',
                        'content' => [
                            'application/json' => [
                                'schema' => [
                ...
                summary: 'Withdraw referral pool',
            ),
        );
        $openApi->getPaths()->addPath('/api/contract/referral-pool/withdraw', $pathItem);
